      ...
      <div className="card  shadow-2xl p-6   border-primary rounded-lg mx-10  ">
        ...
        <div className=" flex  flex-col md:flex-col lg:flex-row   py-10 mx-10 gap-10  ">
          <div class="  ">
            ...
            <div className=" ">
              <Link to="/edit-profile"><button className="btn btn-primary p-4 rounded-full   w-50 mt-4 ml-5">Upload photo</button></Link>
            </div>
          </div>
...
<div class="form-control ">
    ...
    type="text" placeholder="Full Name" name='name' class="input input-bordered   rounded-3xl    " />
  </div>
  <div class="form-control  ">
    <label class="label">
    ...
    <input {...register("email", { required: true,   })}
     type="email" placeholder="email" name='email' class="input input-bordered rounded-3xl    " />
  </div>
  <div class="form-control  ">
    <label class="label">
    ...
    <input {...register("password", { required: true,  })}
     type="password" placeholder="Phone" name='phone' class="input input-bordered rounded-3xl    " />
 ...
 <div className='flex  sm:flex-col sm:w-full md:flex-row gap-3 lg:flex-row   justify-between items-center'>
     ...
     <div class="form-control ">
       ...
       <input  {...register("password", { required: true,  })}
       type="text" placeholder="Current password" name='password' class="input input-bordered   rounded-3xl    " />
     </div>
     <div class="form-control ">
       {/* <label class="label">
       ...
       type="text" placeholder="New password" name='newpassword' class="input input-bordered   rounded-3xl    " />
     </div>
     <div class="form-control ">
       {/* <label class="label">
         <span class="label-text">Full Name</span>
